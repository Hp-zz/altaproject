    ...
    return (
        <div className={styles.summaryItem}>
          ...
          <div className={styles.summaryItemRight}>
            <h4 style={{ color: 'red' }}>
              {props.value.toLocaleString()} <span>{props.icon}</span>
            </h4>
            ...
            <div className={styles.details}>
              <p className={styles.detailsp}>
                ...
                Đang hoạt động: <strong>{props.active.toLocaleString()}</strong>
              </p>
              <p className={styles.detailsp}>
                <span className="dot" style={{ backgroundColor: "#999" }}></span>
                Ngừng hoạt động: <strong>{props.inactive.toLocaleString()}</strong>
              </p>
            </div>
          </div>
        </div>
